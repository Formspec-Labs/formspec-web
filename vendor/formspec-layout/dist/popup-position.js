...
export const MODAL_FIRST_FOCUSABLE_SELECTOR = 'button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';
 ...
 */
export function positionPopupNearTrigger(triggerEl, overlayEl, placement = 'bottom') {
...
export function clearPopupFixedPosition(overlayEl) {
