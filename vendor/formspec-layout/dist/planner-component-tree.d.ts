...
export declare function planComponentTree(tree: ComponentTreeNode, ctx: PlanContext, prefix?: string, customComponentStack?: Set<string>, applyThemePages?: boolean, graphPathSegments?: readonly string[] | null): LayoutNode;
