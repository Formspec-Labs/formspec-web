 ...
 */
export declare const SURFACE_DIAGNOSTIC_CODES: readonly ["APP-ENTRY-AMBIGUOUS", "APP-ENTRY-SURFACE-UNRESOLVED", "BUNDLE-DOCUMENT-MISSING", "BUNDLE-DOCUMENT-SHAPE", "SURFACE-ENTRY-UNRESOLVED", "ROUTE-PATH-COLLISION", "ROUTE-HANDLE-AMBIGUOUS", "ROUTE-PARAM-GRAMMAR", "ROUTE-PARAM-UNDECLARED", "ROUTE-PARAM-NO-MARKER", "ROUTE-PARAM-UNSUPPLIED", "ROUTE-UNMATCHED", "EMBED-ROUTE-UNRESOLVED", "EMBED-ROUTE-CYCLE", "SLOT-TYPE-UNKNOWN", "SLOT-BINDING-INCOMPLETE", "DEFINITION-FORM-DATA-UNAVAILABLE", "EXPERIENCE-UNIT-UNRESOLVED", "WIDGET-UNDECLARED", "WIDGET-UNIMPLEMENTED", "WIDGET-DELIVERY-CONTRACT-MISMATCH", "WIDGET-DATA-REQUIRED-UNAVAILABLE", "WIDGET-ACTION-OUTPUT-UNDECLARED", "WIDGET-ACTION-INPUT-INVALID", "WIDGET-ACTION-OUTPUT-UNMAPPED", "WIDGET-ACTION-REF-UNRESOLVED", "WIDGET-ACTION-TRANSITION-AMBIGUOUS", "REGISTRY-ENTRY-NAME-COLLISION", "STATIC-CONTENT-KIND-UNKNOWN", "STATIC-IMAGE-NO-ALT", "STATIC-IMAGE-SOURCE-REFUSED", "THEME-UNCLASSIFIED-REFUSED", "THEME-DOCUMENT-ROOT-CONTAMINATED", "TRANSITION-CONDITION-UNEVALUABLE", "TRANSITION-UNFIREABLE"];
