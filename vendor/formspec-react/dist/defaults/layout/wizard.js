...
export function Wizard({ node, children }) {
    ...
    const stepBody = (_jsxs(_Fragment, { children: [progressRow, _jsx("div", { className: "formspec-wizard-step-indicator", ref: announcerRef, children: chrome(isLast ? 'wizard.finalStepStatus' : 'wizard.stepStatus', {
                    index: currentStep + 1,
                    total: totalSteps,
                    title,
