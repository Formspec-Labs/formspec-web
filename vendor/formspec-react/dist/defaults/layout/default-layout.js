...
function StackLayout({ node, children, themeClass, style }) {
    ...
    if (title && node.bindPath) {
        return (_jsxs("section", { className: mergeClasses('formspec-group', themeClass), style: surfaceStyle(props, style), ...elevationAttrs(props), ...accessibilityAttrs(node), children: [_jsx("h3", { className: "formspec-group-title", children: title }), children] }));
    }
    return (_jsx("div", { className: mergeClasses('formspec-stack', themeClass), style: stackStyle, children: children }));
}
// ── Grid ─────────────────────────────────────────────────────────
function GridLayout({ node, children, themeClass, style }) {
    ...
    return (_jsx("div", { className: mergeClasses('formspec-grid', themeClass), style: gridStyle, children: children }));
}
// ── Card / Section ────────────────────────────────────────────────
function CardLayout({ node, children, themeClass, style }) {
    ...
    return (_jsxs("section", { className: mergeClasses('formspec-card', themeClass), style: surfaceStyle(props, style), ...elevationAttrs(props), children: [label && _jsx(Heading, { className: "formspec-card-title", children: label }), subtitle && _jsx("p", { className: "formspec-card-subtitle", children: subtitle }), children] }));
}
// ── Divider ───────────────────────────────────────────────────────
function DividerLayout({ node, themeClass, style }) {
    const label = node.props?.label;
    if (label) {
        return (_jsxs("div", { className: mergeClasses('formspec-divider formspec-divider--labeled', themeClass), style: style, children: [_jsx("hr", {}), _jsx("span", { children: label }), _jsx("hr", {})] }));
    }
    return _jsx("hr", { className: mergeClasses('formspec-divider', themeClass), style: style });
}
// ── Section ──────────────────────────────────────────────────────
function SectionLayout({ node, children, themeClass, style }) {
    ...
    const Heading = `h${headingLevel}`;
    return (_jsxs("section", { className: mergeClasses('formspec-section', themeClass), style: surfaceStyle(props, style), ...elevationAttrs(props), children: [title && _jsx(Heading, { children: title }), description && _jsx("p", { className: "formspec-section-description", children: description }), children] }));
}
// ── Collapsible ───────────────────────────────────────────────────
function CollapsibleLayout({ node, children, themeClass, style }) {
    ...
    return (_jsxs("details", { className: mergeClasses('formspec-collapsible', themeClass), style: style, open: defaultOpen || false, children: [_jsx("summary", { children: title }), _jsx("div", { className: "formspec-collapsible-content", children: children })] }));
}
// ── Accordion ────────────────────────────────────────────────────
function AccordionLayout({ node, children, themeClass, style }) {
    ...
    return (_jsx("div", { ref: containerRef, className: mergeClasses('formspec-accordion', themeClass), style: style, onKeyDown: handleKeyDown, children: childArray.map((child, idx) => {
...
function PanelLayout({ node, children, themeClass, style }) {
    ...
    return (_jsxs("div", { className: mergeClasses('formspec-panel', themeClass), style: panelStyle, ...elevationAttrs(props), children: [title && _jsx("div", { className: "formspec-panel-header", children: title }), _jsx("div", { className: "formspec-panel-body", children: children })] }));
}
// ── Modal ─────────────────────────────────────────────────────────
...
function PopoverLayout({ node, children, themeClass, style }) {
    ...
    return (_jsxs("div", { ref: wrapperRef, className: mergeClasses('formspec-popover', themeClass), style: style, children: [_jsx("button", { type: "button", className: "formspec-popover-trigger", ref: triggerRef, "aria-haspopup": "dialog", "aria-expanded": open, onClick: toggle, children: triggerLabel }), _jsx("div", { ref: contentRef, className: "formspec-popover-content", role: "dialog", "aria-label": title ?? triggerLabel, tabIndex: -1, onKeyDown: handleKeyDown, hidden: !open, children: children })] }));
}
// ── Generic fallback ──────────────────────────────────────────────
function DefaultContainer({ node, children, themeClass, style }) {
    return (_jsx("div", { className: mergeClasses(`formspec-${node.component.toLowerCase()}`, themeClass), style: style, children: children }));
}
