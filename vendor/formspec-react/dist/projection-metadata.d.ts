...
export type ProjectionMetadataAttrs = Record<`data-formspec-${string}` | `data-need-${string}`, string>;
export declare function needTraceAttrs(candidates: readonly unknown[] | undefined): ProjectionMetadataAttrs;
...
export declare function projectionMetadataAttrs(node: Pick<LayoutNode, 'componentGraphIdentity' | 'uiGraphRoutePolicy' | 'needAnchors'>): ProjectionMetadataAttrs;
