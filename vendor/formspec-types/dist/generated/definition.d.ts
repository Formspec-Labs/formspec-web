...
export interface Bind {
    ...
    constraint?: string;
    /**
     * Human-readable message displayed when 'constraint' evaluates to false (a CONSTRAINT_FAILED result). MAY contain {{expression}} sequences, resolved as for a Shape message with $ bound to the targeted node. If absent, a generic failure message is generated by the processor. A constraint that fails to parse reports CONSTRAINT_PARSE_ERROR with a processor-generated message instead; this text never labels it (core Phase 3).
     */
