 ...
 */
export type ChromeStringKey = '$ui.select.placeholder' | '$ui.select.clearSelection' | '$ui.select.selectedValues' | '$ui.select.selectAll' | '$ui.repeat.add' | '$ui.repeat.remove' | '$ui.repeat.row' | '$ui.repeat.rowOf' | '$ui.repeat.rowNamed' | '$ui.wizard.next' | '$ui.wizard.nextStep' | '$ui.wizard.previous' | '$ui.wizard.previousStep' | '$ui.wizard.skip' | '$ui.wizard.skipStep' | '$ui.wizard.submit' | '$ui.wizard.submitForm' | '$ui.wizard.steps' | '$ui.wizard.progress' | '$ui.wizard.step' | '$ui.wizard.collapseNavigation' | '$ui.wizard.otherItems' | '$ui.modal.close' | '$ui.alert.dismiss' | '$ui.validationSummary.heading' | '$ui.date.format' | '$ui.characterCount.limit' | '$ui.characterCount.allowed' | '$ui.characterCount.left' | '$ui.characterCount.leftOne' | '$ui.characterCount.over' | '$ui.characterCount.overOne' | '$ui.signature.clear' | '$ui.signature.canvas' | '$ui.money.amount' | '$ui.money.currency' | '$ui.fieldHelp.label' | '$ui.screener.continue' | '$ui.screener.required' | '$ui.screener.back' | '$ui.dataTable.addRow' | '$ui.dataTable.remove' | '$ui.dataTable.removeRow' | '$ui.dataTable.actions' | '$ui.wizard.stepTitle' | '$ui.wizard.stepStatus' | '$ui.wizard.finalStepStatus' | '$ui.wizard.stepAnnouncement' | '$ui.wizard.finalStepAnnouncement' | '$ui.wizard.expandNavigation' | '$ui.select.loadingOptions' | '$ui.select.remoteFallback' | '$ui.select.remoteFailed' | '$ui.modal.open' | '$ui.fileUpload.dropzone' | '$ui.fileUpload.dropzoneKeyboard' | '$ui.fileUpload.browse' | '$ui.validationSummary.fixOne' | '$ui.validationSummary.fixMany' | '$ui.validationSummary.reviewOne' | '$ui.validationSummary.reviewMany' | '$ui.validationSummary.review' | '$ui.validationSummary.errorCountOne' | '$ui.validationSummary.errorCount' | '$ui.validationSummary.issueCountOne' | '$ui.validationSummary.issueCount' | '$ui.validationSummary.row' | '$ui.action.submit' | '$ui.action.inProgress' | '$ui.action.completed' | '$ui.action.blocked' | '$ui.action.failed' | '$ui.action.deferred' | '$ui.action.unresolved' | '$ui.action.status' | '$ui.action.statusReason' | '$ui.screener.submit' | '$ui.screener.answerOne' | '$ui.assist.filled';
/**
