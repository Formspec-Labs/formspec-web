...
export const demoLocaleDocuments: LocaleDocument[] = [
  {
    ...
    strings: {
      ...
      'fullName.hint': 'As it appears on your ID.',
      'email.label': 'Email address',
      'phone.label': 'Phone number',
      'phone.hint': 'Optional.',
      'preferredContact.label': 'Preferred contact method',
      'needsInterpreter.label': 'I need language help',
      'preferredLanguage.label': 'Preferred language',
      'preferredLanguage.hint': 'Shown for {{ $applicant.fullName }} when language help is requested.',
      'household.label': 'Household members',
      'household.description': 'Repeat group example.',
      'memberName.label': 'Member name',
      'memberAge.label': 'Member age',
      'notes.label': 'Anything else we should know?',
      'notes.hint': 'Optional.',
      'supportingDocument.label': 'Supporting document',
      'supportingDocument.hint': 'Optional. Add a photo or PDF that supports your intake.',
  ...
  },
  {
    ...
    strings: {
      ...
      'fullName.hint': 'Como aparece en su identificacion.',
      'email.label': 'Correo electronico',
      'phone.label': 'Numero de telefono',
      'phone.hint': 'Opcional.',
      'preferredContact.label': 'Metodo de contacto preferido',
      'needsInterpreter.label': 'Necesito ayuda con el idioma',
      'preferredLanguage.label': 'Idioma preferido',
      'preferredLanguage.hint': 'Se muestra para {{ $applicant.fullName }} cuando solicita ayuda con el idioma.',
      'household.label': 'Miembros del hogar',
      'household.description': 'Ejemplo de grupo repetible.',
      'memberName.label': 'Nombre del miembro',
      'memberAge.label': 'Edad del miembro',
      'notes.label': 'Algo mas que debamos saber?',
      'notes.hint': 'Opcional.',
      'supportingDocument.label': 'Documento de apoyo',
      'supportingDocument.hint': 'Opcional. Agregue una foto o PDF que respalde su solicitud.',
