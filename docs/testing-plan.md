...
| Port conformance | `npm run test:conformance` | Yes | First-party adapters for `DefinitionSource`, `DraftStore`, `SubmitTransport`, `IdentityProvider`, `NotificationDelivery`, `RespondentPlaceSource`, and `StatusReader`. |
