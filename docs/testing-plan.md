...
| M6 respondent runtime | Hydration helpers, intake handoff shape, invalid submit behavior, Problem JSON rendering, mobile smoke, axe checks, static first-paint and no-JavaScript fallback behavior, JS bundle budget, production asset compression, and UX docs. | `tests/app/respondent-flow.test.ts`; `tests/app/respondent-runtime.test.tsx`; `tests/e2e/placeholder-a11y.spec.ts`; `scripts/check-bundle-budget.mjs`; `scripts/check-deployment-headers.mjs`; `docs/ux/branding.md`; `docs/ux/errors.md`; `docs/ux/responsive.md`; `docs/ux/accessibility.md`; `docs/ux/i18n.md`. |
