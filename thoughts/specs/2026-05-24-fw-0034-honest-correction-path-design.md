...
5. **AI-agent-as-respondent correction authority (§2.4) — partially resolved 2026-05-24.** When an AI agent filed per [FW-0058 design 2026-05-24](2026-05-24-fw-0058-ai-agent-filer-chain-design.md), the substrate shape is clear: per [FW-0058 §7.5](2026-05-24-fw-0058-ai-agent-filer-chain-design.md), the correction's `AuthoredSignature` carries the SAME `agentChain` as the original filing (or a refreshed chain if delegation changed); the correction rides EXT-5's existing per-signer attribution. **Substantive correction authority** (which principal in the chain may authorize a correction — the acting agent, the operator, or the accountable human) is the WOS workflow author's deontic-constraint declaration, NOT a FW-0034 substrate concern. Composition with FW-0037 + FW-0058 substrate-coherent; per-deployment authority semantics deferred; not load-bearing for slice 1.
