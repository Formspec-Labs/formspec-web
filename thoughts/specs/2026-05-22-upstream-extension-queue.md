...
**Status:** not yet filed. Payload-shape extensions proposed 2026-05-23 by FW-0048 design (`submission.duress-signaled`); extended 2026-05-24 by FW-0034 design (`response.withdrawn` / `response.dispute-attached` `partyRef`); extended 2026-05-24 by FW-0036 design (`bot-protection-cleared` payload closure).
